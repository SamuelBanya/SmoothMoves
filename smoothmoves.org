...
<2022-09-21 Wed 21:26>: In order to add CRUD (Create, Read, Update, Delete) methods for the 'users' table, I modified the contents of the 'application_controller.rb' file with the following:
#+begin_src ruby
